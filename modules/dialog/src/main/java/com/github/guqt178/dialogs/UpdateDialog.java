...
public final class UpdateDialog {
    ...
    public static final class Builder
        ...
        private void downloadApk() {
            ...
            mApkFile = new File(getContext().getExternalCacheDir(), getString(R.string.app_name) + "_v" + mNameView.getText().toString() + ".apk");
            // 设置对话框不能被取消
            setCancelable(false);
        ...
        private void installApk() {
            ...
            if (Build.VERSION.SDK_INT >= Build.VERSION_CODES.N) {
                uri = FileProvider.getUriForFile(getContext(),  ".provider", mApkFile);
