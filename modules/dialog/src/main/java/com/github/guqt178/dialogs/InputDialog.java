...
public final class InputDialog {
    ...
    public static final class Builder
        ...
        public void onShow(BaseDialog dialog) {
            postDelayed(() -> getInputManager().showSoftInput(mInputView, 0), 500);
        }
        ...
        public void onDismiss(BaseDialog dialog) {
            getInputManager().hideSoftInputFromWindow(mInputView.getWindowToken(), 0);
        }

        private InputMethodManager getInputManager() {
            InputMethodManager result = getSystemService(Context.INPUT_METHOD_SERVICE);
            return result;
        }
