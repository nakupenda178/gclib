...
import com.github.guqt178.dialogs.base.BaseAdapter;
import com.github.guqt178.dialogs.base.BaseDialog;
import com.github.guqt178.dialogs.base.MyAdapter;
        ...
        public void onClick(View v) {
            ...
            if (id == R.id.tv_ui_confirm) {
                ...
                if (data.size() >= mAdapter.getMinSelect()) {
                    ...
                    Toast.makeText(getContext(), String.format(getString(R.string.select_min_hint), mAdapter.getMinSelect()), Toast.LENGTH_SHORT).show();
                }
        ...
        public void onItemClick(RecyclerView recyclerView, View itemView, int position) {
            if (mSelectSet.containsKey(position)) {
                ...
                if (mSelectSet.size() < mMaxSelect) {
                    ...
                    Toast.makeText(getContext(), String.format(getString(R.string.select_max_hint), mMaxSelect), Toast.LENGTH_SHORT).show();
