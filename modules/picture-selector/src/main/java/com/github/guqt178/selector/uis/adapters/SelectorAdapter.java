...
public class SelectorAdapter extends RecyclerView.Adapter<RecyclerView.ViewHolder> {
    ...
    public void onBindViewHolder(@NonNull final RecyclerView.ViewHolder holder, int position) {
        ...
        //PSGlideUtil.loadImage(mContext, PSUtil.createFileUrl(mContext,entity.getPath()), realHolder.mImgContent);
        PSGlideUtil.loadImage(mContext, PSUtil.getUriFromPath(mContext,entity.getPath()), realHolder.mImgContent);
