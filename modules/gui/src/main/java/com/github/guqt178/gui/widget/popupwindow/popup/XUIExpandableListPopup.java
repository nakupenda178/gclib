...
package com.github.guqt178.gui.widget.popupwindow.popup;
...
import com.github.guqt178.gui.widget.XUIWrapContentExpandableListView;
...
public class XUIExpandableListPopup<T extends XUIExpandableListPopup> extends XUIPopup {
    ...
    private void updateDivider(ExpandableListView listView) {
        if (mHasDivider) {
            ...
            listView.setDividerHeight(DensityUtils.dp2px(getContext(), GUI.isTablet() ? 1F : 0.5F));
        } else {
