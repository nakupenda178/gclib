...
package com.github.guqt178.gui.widget.actionbar;
...
import com.github.guqt178.gui.widget.alpha.XUIAlphaImageView;
import com.github.guqt178.gui.widget.alpha.XUIAlphaLinearLayout;
import com.github.guqt178.gui.widget.alpha.XUIAlphaTextView;
import com.github.guqt178.gui.widget.textview.AutoMoveTextView;
...
public class TitleBar extends ViewGroup implements View.OnClickListener, HasTypeface {
    ...
    private void initView(Context context) {
        ...
        mLeftText.setTypeface(GUI.getDefaultTypeface());
        ...
        mCenterText.setTypeface(GUI.getDefaultTypeface());
        ...
        mSubTitleText.setTypeface(GUI.getDefaultTypeface());
    ...
    protected View inflateAction(Action action) {
        ...
        if (TextUtils.isEmpty(action.getText())) {
            ...
            text.setTypeface(GUI.getDefaultTypeface());
