 ...
 * 分隔线
 */
class DividerLine(context: Context) : RecyclerView.ItemDecoration() {
    //divider对应的drawable
    ...
    companion object {
        ...
        private fun dp2px(defVal: Number): Int {
            return TypedValue.applyDimension(TypedValue.COMPLEX_UNIT_DIP, defVal.toFloat(), Resources.getSystem().displayMetrics).toInt()
        }
    }
}