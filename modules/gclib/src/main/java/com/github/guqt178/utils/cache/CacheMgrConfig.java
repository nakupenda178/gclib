...
import com.github.guqt178.utils.cache.strategy.IEncryptStrategy;
import com.github.guqt178.utils.cache.strategy.KeyStoreEncryptStrategy;
...
public class CacheMgrConfig {
    ...
    private CacheMgrConfig(Builder builder) {
    ...
    public static class Builder {
        ...
        public CacheMgrConfig build() {
            ...
            return new CacheMgrConfig(this);
        }
    }
}
