...
/**
 * 仿高德地图打车的三段式BottomSheet
 * An interaction behavior plugin for a child view of {@link CoordinatorLayout} to make it work as
 * a bottom sheet.
 */
public class LayerBehavior<V extends View> extends CoordinatorLayout.Behavior<V>
{
     ...
     */
    public LayerBehavior(Context context, AttributeSet attrs)
    {
        super(context, attrs);
    ...
    /**
     * A utility function to get the {@link LayerBehavior} associated with the {@code view}.
     *
     * @param view The {@link View} with {@link LayerBehavior}.
     * @return The {@link LayerBehavior} associated with the {@code view}.
     */
    @SuppressWarnings("unchecked")
    public static <V extends View> LayerBehavior<V> from(V view)
    {
        ...
        CoordinatorLayout.Behavior behavior = ((CoordinatorLayout.LayoutParams) params)
                .getBehavior();
        if (!(behavior instanceof LayerBehavior))
        {
            throw new IllegalArgumentException(
                    "The view is not associated with BottomSheetBehavior");
        }
        return (LayerBehavior<V>) behavior;
    }
