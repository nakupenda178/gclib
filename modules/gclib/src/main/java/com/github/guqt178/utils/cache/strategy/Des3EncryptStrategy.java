...
import com.github.guqt178.utils.cache.util.Des3Util;
import com.github.guqt178.utils.cache.util.KeyStoreHelper;
...
public class Des3EncryptStrategy implements IEncryptStrategy {
    ...
    public Des3EncryptStrategy(Context context, String secretKey) {
        this(context, secretKey, "haohaoha");
    }
