...
public class ProgressLayoutState extends LayoutState {
    ...
    private ProgressLayoutState(Builder builder) {
    ...
    public static class Builder {
        ...
        public ProgressLayoutState build() {
            return new ProgressLayoutState(this);
        }
    }
}